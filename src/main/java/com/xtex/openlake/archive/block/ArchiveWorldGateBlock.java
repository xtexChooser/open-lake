...
public class ArchiveWorldGateBlock extends Block {
    ...
    public static final EntityAttribute ATTRIBUTE_TELEPORT_Y = new ClampedEntityAttribute("atttribute.open-lake.archive_teleport_y", 0.0f, Integer.MIN_VALUE, Integer.MAX_VALUE);
    public static final Identifier ATTRIBUTE_TELEPORT_Z_IDENTIFIER = id("archive.teleport.z");
    public static final EntityAttribute ATTRIBUTE_TELEPORT_Z = new ClampedEntityAttribute("atttribute.open-lake.archive_teleport_z", 0.0f, Integer.MIN_VALUE, Integer.MAX_VALUE);
